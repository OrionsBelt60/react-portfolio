...
class Blog extends Component {
   constructor() {
      ...
      this.handleCloseNewBlog = this. handleCloseNewBlog.bind(this);
   ...
   getBlogItems() {
      ...
      axios.get(`https://owenpozo.devcamp.space/portfolio/portfolio_blogs?page=${this
      .state.currentPage}`,
       {
          withCredentials: true 
         }
   ...
   return ( 
      <div className="blog-container">
         ...
         handleModalClose={this.handleCloseNewBlog}
         />
         {this.props.LIS === "LOGGED_IN" ? 
         (
